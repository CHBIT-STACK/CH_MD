...
global.session = "https://CH_md-pair.onrender.com";

module.exports = {
    SESSION_ID: process.env.SESSION_ID || "CH_MD~hjVKWGwbZ+4wBpX3s4gIePwCUQlDafwcAAA==", // Add sess Id here especially when deploying on panels else use app.json and .env file...
    ...
    STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "✅️ STATUS VIEWED BY CH-MD", // Custom message
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923038732135", // Only 1 owner number here, others add to sudo numbers
    OWNER_NAME: process.env.OWNER_NAME || "𓂃ᷱ᪳𝙲𝙷𝙱𝙸𝚃-𝚂𝚃𝙰𝙲𝙺^᪲᪲᪲輪", // Custom name
    ...
    BOT_NAME: process.env.BOT_NAME || "𓆩ု᪳ᶜᴴ⁻ᴹᴰ𓆪", // Don't change
    BOT_PIC: process.env.BOT_PIC || "https://postimg.cc/zyDg4v57", // Don't change
    AUTO_AUDIO: process.env.AUTO_AUDIO || "false",
    AUTO_BIO: process.env.AUTO_BIO || "false",
    AUTO_BIO_QUOTE: process.env.AUTO_BIO_QUOTE || "CH MD ALIVE",
